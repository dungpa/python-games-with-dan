...
easy_lair = {
    "dragon": Actor("salasleep", pos=(600, 100)),
...
medium_lair = {
    "dragon": Actor("salasleep", pos=(600, 300)),
...
hard_lair = {
    "dragon": Actor("salasleep", pos=(600, 500)),
...
gallade = Actor("galladehero", pos=GALLADE_START)
...
def check_for_collisions():
    ...
    for lair in lairs:
        ...
        if lair["dragon"].image == "salawake" and reset_required is False:
            check_for_dragon_collision(lair)
            
def check_for_dragon_collision(lair):
    x_distance = gallade.x - lair["dragon"].x
...
def update_lairs():
    ...
    for lair in lairs:
        if lair["dragon"].image == "salasleep":
